...
CREATE TABLE "ScriptSettings" (
    ...
    "bodyStartEnabled" BOOLEAN NOT NULL DEFAULT true,
    "footerScripts" TEXT,
    "footerEnabled" BOOLEAN NOT NULL DEFAULT true,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ScriptSettings_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "StoreSettings" (
    "id" TEXT NOT NULL DEFAULT 'default',
    "storeName" TEXT NOT NULL DEFAULT 'Verdant Organic Market',
    "logoUrl" TEXT,
    "currency" TEXT NOT NULL DEFAULT 'USD',
    "currencySymbol" TEXT NOT NULL DEFAULT '$',
    "supportEmail" TEXT NOT NULL DEFAULT 'hello@verdantmarket.com',
    "supportPhone" TEXT NOT NULL DEFAULT '+1 (555) 010-2345',
    "addressLine" TEXT,
    "shippingFlatCents" INTEGER NOT NULL DEFAULT 599,
    "freeShippingThreshold" INTEGER NOT NULL DEFAULT 7500,
...
-- AddForeignKey
ALTER TABLE "WebhookDelivery" ADD CONSTRAINT "WebhookDelivery_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE SET NULL ON UPDATE CASCADE;
