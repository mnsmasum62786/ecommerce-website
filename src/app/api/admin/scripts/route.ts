...
const scriptSchema = z.object({
  ...
  metaTestEventCode: z.string().trim().optional().nullable(),
...
export async function PUT(req: Request) {
  ...
  const data = {
    ...
    metaAccessToken: d.metaAccessToken?.trim() || null,
    metaTestEventCode: d.metaTestEventCode?.trim() || null,
    metaCapiEnabled: d.metaCapiEnabled,
