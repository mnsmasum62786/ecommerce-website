...
const PRODUCTS: SeedProduct[] = [
  ...
  { name: "Organic Kombucha — Ginger", slug: "organic-kombucha-ginger", category: "beverages", price: 3.99, unit: "16 oz", stock: 90, shortDesc: "Fizzy, gut-friendly ginger kombucha.", description: "Living, raw kombucha fermented with organic green tea and a kick of fresh ginger. Lightly effervescent with billions of probiotics per bottle.", certification: "USDA Organic", tags: ["probiotic", "vegan", "fermented"], image: "https://loremflickr.com/800/800/kombucha,drink/all?lock=11" },
